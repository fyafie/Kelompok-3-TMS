...
public class TestTambahDivisi {
    ...
    public void input_divisi_gagal_dan_ada_pemberitahuan_untuk_input_nama_divisi() {
    	Assert.assertEquals(driver.getCurrentUrl(), "https://dev.ptdika.com/tiket.com/admin/master_divisi");
    	extentTest.log(LogStatus.PASS, "Input divisi gagal dan ada pemberitahuan untuk input nama divisi");
    	Hooks.delay(1);
    }
